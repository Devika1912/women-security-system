...
<html>
    ...
    <body>
        <header>
            ...
            <button><a href="login1.jsp">Login</a></button>
            <button><a href="profilejsp.jsp">Profile</a></button>
        </header>
                    ...
                    <div class="form-box login">
                        ...
                        <form action="#">
                            ...
                            <div class="login-register">
                                <p>Don't have an account?<a href="registerationjsp_1.jsp" class="register-link">Register</a></p>
